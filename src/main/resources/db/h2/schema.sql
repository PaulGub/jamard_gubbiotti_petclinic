...
ALTER TABLE memos
    ADD CONSTRAINT fk_memos_vets FOREIGN KEY (vet_id) REFERENCES vets (id);
...
ALTER TABLE operations
    ADD CONSTRAINT fk_operations_vets FOREIGN KEY (vet_id) REFERENCES vets (id);
CREATE INDEX operations_vet_id ON operations (vet_id);
ALTER TABLE operations
    ADD CONSTRAINT fk_operations_pets FOREIGN KEY (pet_id) REFERENCES pets (id);
CREATE INDEX operations_pet_id ON operations (pet_id);
